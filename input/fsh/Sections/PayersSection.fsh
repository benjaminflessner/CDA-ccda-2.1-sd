...
Parent: $Section
Id: 2.16.840.1.113883.10.20.22.2.18
...
* templateId[primary] ^requirements = "SHALL contain exactly one [1..1] templateId (CONF:1198-7924) such that it"
  * root 1..1
  * root = "2.16.840.1.113883.10.20.22.2.18"
    * ^requirements = "SHALL contain exactly one [1..1] @root=\"2.16.840.1.113883.10.20.22.2.18\" (CONF:1198-10434)."
  * extension 1..1
  * extension = "2015-08-01"
    * ^requirements = "SHALL contain exactly one [1..1] @extension=\"2015-08-01\" (CONF:1198-32597)."
* code 1..1
  * ^requirements = "SHALL contain exactly one [1..1] code (CONF:1198-15395)."
  * code 1..1
  * code = "48768-6"
    * ^requirements = "This code SHALL contain exactly one [1..1] @code=\"48768-6\" Payers (CONF:1198-15396)."
  * codeSystem 1..1
  * codeSystem = "2.16.840.1.113883.6.1"
    * ^requirements = "This code SHALL contain exactly one [1..1] @codeSystem=\"2.16.840.1.113883.6.1\" (CodeSystem: LOINC urn:oid:2.16.840.1.113883.6.1) (CONF:1198-32149)."
* title 1..1
  * ^requirements = "SHALL contain exactly one [1..1] title (CONF:1198-7926)."
* text 1..1
  * ^requirements = "SHALL contain exactly one [1..1] text (CONF:1198-7927)."
* entry ^slicing.discriminator[0].type = #value
  * ^slicing.discriminator[=].path = "act"
  * ^slicing.rules = #open
* entry contains coverage 0..*
* entry[coverage] ^requirements = "SHOULD contain zero or more [0..*] entry (CONF:1198-7959) such that it"
  * act 1..1
  * act only CoverageActivity
    * ^requirements = "SHALL contain exactly one [1..1] Coverage Activity (V3) (identifier: urn:hl7ii:2.16.840.1.113883.10.20.22.4.60:2015-08-01) (CONF:1198-15501)."