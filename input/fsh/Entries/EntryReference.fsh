...
Parent: $Act
Id: 2.16.840.1.113883.10.20.22.4.122
...
* classCode 1..1
* classCode = #ACT
  * ^requirements = "SHALL contain exactly one [1..1] @classCode=\"ACT\" (CodeSystem: HL7ActClass urn:oid:2.16.840.1.113883.5.6) (CONF:1098-31485)."
* moodCode 1..1
* moodCode = #EVN
  * ^requirements = "SHALL contain exactly one [1..1] @moodCode=\"EVN\" (CodeSystem: HL7ActMood urn:oid:2.16.840.1.113883.5.1001) (CONF:1098-31486)."
* templateId ^slicing.discriminator.type = #value
  * ^slicing.discriminator.path = "root"
  * ^slicing.rules = #open
* templateId contains primary 1..1
* templateId[primary] ^requirements = "SHALL contain exactly one [1..1] templateId (CONF:1098-31487) such that it"
  * root 1..1
  * root = "2.16.840.1.113883.10.20.22.4.122"
    * ^requirements = "SHALL contain exactly one [1..1] @root=\"2.16.840.1.113883.10.20.22.4.122\" (CONF:1098-31488)."
* id 1..*
  ...
  * ^requirements = "SHALL contain at least one [1..*] id (CONF:1098-31489)."
* code 1..1
  * ^requirements = "SHALL contain exactly one [1..1] code (CONF:1098-31490)."
  * nullFlavor 1..1
  * nullFlavor = #NP
    * ^requirements = "This code SHALL contain exactly one [1..1] @nullFlavor=\"NP\" Not Present (CodeSystem: HL7NullFlavor urn:oid:2.16.840.1.113883.5.1008) (CONF:1098-31491)."
* statusCode 1..1
  * ^requirements = "SHALL contain exactly one [1..1] statusCode (CONF:1098-31498)."
  * code 0..1
  * code = "completed"
    * ^requirements = "This statusCode MAY contain zero or one [0..1] @code=\"completed\" (CodeSystem: HL7ActStatus urn:oid:2.16.840.1.113883.5.14) (CONF:1098-31499)."