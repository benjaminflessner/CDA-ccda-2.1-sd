...
Id: 2.16.840.1.113883.10.20.29.1
Title: "US Realm Header for Patient Generated Document"
Description: """This template is designed to be used in conjunction with the US Realm Header (V2). It includes additional conformances which further constrain the US Realm Header (V2). 
...
* templateId[secondary] obeys 1198-32945
  * ^requirements = "SHALL contain exactly one [1..1] templateId (CONF:1198-28458) such that it"
  * root 1..1
  * root = "2.16.840.1.113883.10.20.29.1"
    * ^requirements = "SHALL contain exactly one [1..1] @root=\"2.16.840.1.113883.10.20.29.1\" (CONF:1198-28459)."
  * extension 1..1
  * extension = "2015-08-01"
    * ^requirements = "SHALL contain exactly one [1..1] @extension=\"2015-08-01\" (CONF:1198-32917)."
* recordTarget 1..1
  ...
  * ^requirements = "SHALL contain exactly one [1..1] recordTarget (CONF:1198-28460)."
  * patientRole 1..1
    * ^requirements = "This recordTarget SHALL contain exactly one [1..1] patientRole (CONF:1198-28461)."
    * id 1..*
      * ^requirements = "This patientRole SHALL contain at least one [1..*] id (CONF:1198-28462)."
    * patient 1..1
      * ^requirements = "This patientRole SHALL contain exactly one [1..1] patient (CONF:1198-28465)."
      * guardian 0..*
        * ^requirements = "This patient MAY contain zero or more [0..*] guardian (CONF:1198-28469)."
        * id 0..*
          * ^requirements = "The guardian, if present, SHOULD contain zero or more [0..*] id (CONF:1198-28470)."
        * code 0..1
        * code from $2.16.840.1.113883.11.20.12.1 (required)
          * ^requirements = "The guardian, if present, SHOULD contain zero or one [0..1] code, which SHALL be selected from ValueSet Personal And Legal Relationship Role Type urn:oid:2.16.840.1.113883.11.20.12.1 DYNAMIC (CONF:1198-28473)."
      * languageCommunication 0..*
        * ^requirements = "This patient SHOULD contain zero or more [0..*] languageCommunication (CONF:1198-28474)."
        * preferenceInd 0..1
          * ^label = "Indicates a preference for information about care delivery and treatments be communicated (or translated if needed) into this language.\n\nIf more than one languageCommunication is present, only one languageCommunication element SHALL have a preferenceInd with a value of 1.\n"
          ...
          * ^requirements = "The languageCommunication, if present, MAY contain zero or one [0..1] preferenceInd (CONF:1198-28475)."
    * providerOrganization 0..1
      ...
      * ^requirements = "This patientRole MAY contain zero or one [0..1] providerOrganization (CONF:1198-28476)."
* author 1..*
  ...
  * ^requirements = "SHALL contain at least one [1..*] author (CONF:1198-28477)."
  * assignedAuthor 1..1
    * ^requirements = "Such authors SHALL contain exactly one [1..1] assignedAuthor (CONF:1198-28478)."
    * id 1..*
      * ^requirements = "This assignedAuthor SHALL contain at least one [1..*] id (CONF:1198-28479)."
    * code 0..1
      ...
      * ^requirements = "This assignedAuthor SHOULD contain zero or one [0..1] code (CONF:1198-28481)."
      * code 1..1
      * code from $2.16.840.1.113883.11.20.12.1 (preferred)
        * ^requirements = "The code, if present, SHALL contain exactly one [1..1] @code, which SHOULD be selected from ValueSet Personal And Legal Relationship Role Type urn:oid:2.16.840.1.113883.11.20.12.1 DYNAMIC (CONF:1198-28676)."
* dataEnterer 0..1
  ...
  * ^requirements = "MAY contain zero or one [0..1] dataEnterer (CONF:1198-28678)."
  * assignedEntity 1..1
    * ^requirements = "The dataEnterer, if present, SHALL contain exactly one [1..1] assignedEntity (CONF:1198-28679)."
    * code 0..1
    * code from $2.16.840.1.113883.11.20.12.1 (preferred)
      * ^requirements = "This assignedEntity MAY contain zero or one [0..1] code, which SHOULD be selected from ValueSet Personal And Legal Relationship Role Type urn:oid:2.16.840.1.113883.11.20.12.1 DYNAMIC (CONF:1198-28680)."
...
* informant[informant1] 0..*
  * ^requirements = "MAY contain zero or more [0..*] informant (CONF:1198-28681) such that it"
  * relatedEntity 1..1
    * ^requirements = "SHALL contain exactly one [1..1] relatedEntity (CONF:1198-28682)."
    * code 0..1
      * ^requirements = "This relatedEntity MAY contain zero or one [0..1] code (CONF:1198-28683)."
      * code 0..1
      * code from $2.16.840.1.113883.11.20.12.1 (preferred)
        * ^requirements = "The code, if present, SHOULD contain zero or one [0..1] @code, which SHOULD be selected from ValueSet Personal And Legal Relationship Role Type urn:oid:2.16.840.1.113883.11.20.12.1 DYNAMIC (CONF:1198-28684)."
* custodian 1..1
  ...
  * ^requirements = "SHALL contain exactly one [1..1] custodian (CONF:1198-28685)."
  * assignedCustodian 1..1
    * ^requirements = "This custodian SHALL contain exactly one [1..1] assignedCustodian (CONF:1198-28686)."
    * representedCustodianOrganization 1..1
      ...
      * ^requirements = "This assignedCustodian SHALL contain exactly one [1..1] representedCustodianOrganization (CONF:1198-28687)."
      * id 1..*
        ...
        * ^requirements = "This representedCustodianOrganization SHALL contain at least one [1..*] id (CONF:1198-28688)."
* informationRecipient 0..*
  ...
  * ^requirements = "MAY contain zero or more [0..*] informationRecipient (CONF:1198-28690)."
  * intendedRecipient 1..1
    * ^requirements = "The informationRecipient, if present, SHALL contain exactly one [1..1] intendedRecipient (CONF:1198-28691)."
    * id 0..*
      ...
      * ^requirements = "This intendedRecipient SHOULD contain zero or more [0..*] id (CONF:1198-28692)."
      * root 0..1
        ...
        * ^requirements = "The id, if present, SHOULD contain zero or one [0..1] @root (CONF:1198-28693)."
* legalAuthenticator 0..1
  ...
  * ^requirements = "MAY contain zero or one [0..1] legalAuthenticator (CONF:1198-28694)."
  * assignedEntity 1..1
    * ^requirements = "The legalAuthenticator, if present, SHALL contain exactly one [1..1] assignedEntity (CONF:1198-28695)."
    * id 1..*
      * ^short = "The combined @root and @extension  attributes to record the information recipient's identity in a secure, trusted, and unique way."
      * ^requirements = "This assignedEntity SHALL contain at least one [1..*] id (CONF:1198-28696)."
    * code 0..1
      * ^requirements = "This assignedEntity MAY contain zero or one [0..1] code (CONF:1198-28697)."
      * code 0..1
      * code from $2.16.840.1.113883.11.20.12.1 (preferred)
        * ^requirements = "The code, if present, MAY contain zero or one [0..1] @code, which SHOULD be selected from ValueSet Personal And Legal Relationship Role Type urn:oid:2.16.840.1.113883.11.20.12.1 DYNAMIC (CONF:1198-28698)."
* authenticator 0..*
  * ^requirements = "MAY contain zero or more [0..*] authenticator (CONF:1198-28699)."
  * assignedEntity 1..1
    * ^requirements = "The authenticator, if present, SHALL contain exactly one [1..1] assignedEntity (CONF:1198-28700)."
    * id 1..*
      ...
      * ^requirements = "This assignedEntity SHALL contain at least one [1..*] id (CONF:1198-28701)."
    * code 0..1
    * code from $2.16.840.1.113883.11.20.12.1 (preferred)
      * ^requirements = "This assignedEntity SHOULD contain zero or one [0..1] code, which SHOULD be selected from ValueSet Personal And Legal Relationship Role Type urn:oid:2.16.840.1.113883.11.20.12.1 DYNAMIC (CONF:1198-28702)."
* participant 0..*
  ...
  * ^requirements = "MAY contain zero or more [0..*] participant (CONF:1198-28703)."
  * typeCode 1..1
    ...
    * ^requirements = "The participant, if present, SHALL contain exactly one [1..1] @typeCode (CONF:1198-28704)."
  * associatedEntity 1..1
    * ^requirements = "The participant, if present, SHALL contain exactly one [1..1] associatedEntity (CONF:1198-28705)."
    * code 0..1
    * code from $2.16.840.1.113883.11.20.12.1 (preferred)
      * ^requirements = "This associatedEntity SHOULD contain zero or one [0..1] code, which SHOULD be selected from ValueSet Personal And Legal Relationship Role Type urn:oid:2.16.840.1.113883.11.20.12.1 DYNAMIC (CONF:1198-28706)."
* inFulfillmentOf 0..*
  * ^requirements = "MAY contain zero or more [0..*] inFulfillmentOf (CONF:1198-28707)."
  * order 1..1
    * ^requirements = "The inFulfillmentOf, if present, SHALL contain exactly one [1..1] order (CONF:1198-28708)."
    * id 1..*
      * ^short = "A scheduled appointment or service event in a practice management system may be represented using this id element."
      * ^requirements = "This order SHALL contain at least one [1..*] id (CONF:1198-28709)."
* documentationOf 0..*
  * ^requirements = "MAY contain zero or more [0..*] documentationOf (CONF:1198-28710)."
  * serviceEvent 1..1
    * ^requirements = "The documentationOf, if present, SHALL contain exactly one [1..1] serviceEvent (CONF:1198-28711)."
    * code 0..1
      ...
      * ^requirements = "This serviceEvent SHOULD contain zero or one [0..1] code (CONF:1198-28712)."
    * performer 0..*
      * ^requirements = "This serviceEvent SHOULD contain zero or more [0..*] performer (CONF:1198-28713)."
      * functionCode 0..1
        ...
        * ^requirements = "The performer, if present, MAY contain zero or one [0..1] functionCode (CONF:1198-28714)."
      * assignedEntity 1..1
        * ^requirements = "The performer, if present, SHALL contain exactly one [1..1] assignedEntity (CONF:1198-28715)."
        * id 1..*
          * ^short = "The combined @root and @extension  attributes record the performer's identity in a secure, trusted, and unique way."
          * ^requirements = "This assignedEntity SHALL contain at least one [1..*] id (CONF:1198-28716)."
        * code 0..1
        * code from $2.16.840.1.113883.11.20.12.1 (preferred)
          ...
          * ^requirements = "This assignedEntity MAY contain zero or one [0..1] code, which SHOULD be selected from ValueSet Personal And Legal Relationship Role Type urn:oid:2.16.840.1.113883.11.20.12.1 DYNAMIC (CONF:1198-28718)."

Invariant: 1198-32945
