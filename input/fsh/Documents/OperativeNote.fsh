...
* templateId[secondary] obeys 1198-32940
...
* code 1..1
  ...
  * code 1..1
  * code from $2.16.840.1.113883.11.20.1.1 (required)
...
* serviceEvent.ClinicalDocument.documentationOf.serviceEvent
  ...
  * performer[performer2] ^requirements = "This serviceEvent MAY contain zero or more [0..*] performer (CONF:1198-32736) such that it"
    * typeCode 1..1
    * typeCode = #SPRF
...
* component 1..1
  ...
  * structuredBody 1..1
    ...
    * component[component1] ^requirements = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30486)."
      * section 1..1
...
* structuredBody.ClinicalDocument.component.structuredBody
  * component contains
      ...
      component15 0..1 and
      component16 0..1
  * component[component2] ^requirements = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30488) such that it"
    * section 1..1
  ...
  * component[component3] ^requirements = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30490) such that it"
    * section 1..1
  ...
  * component[component4] ^requirements = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30492) such that it"
    * section 1..1
  ...
  * component[component5] ^requirements = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30494) such that it"
    * section 1..1
  ...
  * component[component6] ^requirements = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30496) such that it"
    * section 1..1
  ...
  * component[component7] ^requirements = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30498) such that it"
    * section 1..1
  ...
  * component[component8] ^requirements = "This structuredBody SHALL contain exactly one [1..1] component (CONF:1198-30500) such that it"
    * section 1..1
  ...
  * component[component9] ^requirements = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30502) such that it"
    * section 1..1
  ...
  * component[component10] ^requirements = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30504) such that it"
    * section 1..1
  ...
  * component[component11] ^requirements = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30506) such that it"
    * section 1..1
  ...
  * component[component12] ^requirements = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30508) such that it"
    * section 1..1
  ...
  * component[component13] ^requirements = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30510) such that it"
    * section 1..1
  ...
  * component[component14] ^requirements = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30512) such that it"
    * section 1..1
  ...
  * component[component15] ^requirements = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30514) such that it"
    * section 1..1
  ...
  * component[component16] ^requirements = "This structuredBody MAY contain zero or one [0..1] component (CONF:1198-30516) such that it"
    * section 1..1
