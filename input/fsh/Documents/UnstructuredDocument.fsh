...
Id: 2.16.840.1.113883.10.20.22.1.10
...
* templateId[primary] 1..1
  * obeys 1198-32944
  * ^requirements = "SHALL contain exactly one [1..1] templateId (CONF:1198-7710) such that it"
  * root 1..1
  * root = "2.16.840.1.113883.10.20.22.1.10"
    * ^requirements = "SHALL contain exactly one [1..1] @root=\"2.16.840.1.113883.10.20.22.1.10\" (CONF:1198-10054)."
  * extension 1..1
  * extension = "2015-08-01"
    * ^requirements = "SHALL contain exactly one [1..1] @extension=\"2015-08-01\" (CONF:1198-32522)."
* recordTarget 1..*
  * ^requirements = "SHALL contain at least one [1..*] recordTarget (CONF:1198-31089)."
  * patientRole 1..1
    * ^requirements = "Such recordTargets SHALL contain exactly one [1..1] patientRole (CONF:1198-31090)."
    * id 1..*
      * ^requirements = "This patientRole SHALL contain at least one [1..*] id (CONF:1198-31091)."
* custodian 1..1
  * ^requirements = "SHALL contain exactly one [1..1] custodian (CONF:1198-31096)."
  * assignedCustodian 1..1
    * ^requirements = "This custodian SHALL contain exactly one [1..1] assignedCustodian (CONF:1198-31097)."
    * representedCustodianOrganization 1..1
      * ^requirements = "This assignedCustodian SHALL contain exactly one [1..1] representedCustodianOrganization (CONF:1198-31098)."
* component 1..1
  * ^requirements = "SHALL contain exactly one [1..1] component (CONF:1198-31085)."
  * nonXMLBody 1..1
    ...
    * ^requirements = "This component SHALL contain exactly one [1..1] nonXMLBody (CONF:1198-31086)."
    * text 1..1
      * obeys 1198-7624 and 1198-7623
      * ^requirements = "This nonXMLBody SHALL contain exactly one [1..1] text (CONF:1198-31087)."

Invariant: 1198-32944
